...
Config.Zones = {
    {
        ...
        categories = {
            {label = 'Armas blancas', name = 'melee'},
            {label = 'Pistola', name = 'pistol'}
        },
        Weapons = {
    ...
    },
    {
        ...
        categories = {
            {label = 'Francotiradores', name = 'sniper'}, -- you can make the categories that u want.
            {label = 'Escopetas', name = 'shotguns'},
            {label = 'Pistolas', name = 'pistol'},
            {label = 'Granadas', name = 'grenade'},
        },
        Weapons = {
